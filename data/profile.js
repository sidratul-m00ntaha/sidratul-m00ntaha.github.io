// ============================================================
// PROFILE — who you are. Edit freely; the site re-renders it.
// ============================================================
...
window.DATA.profile = {
  ...
  headline: "I teach machines to see, read & understand.",
  tagline:
    "CSE undergraduate at CUET focused on Computer Vision, NLP and multimodal AI — bridging research with real-world, human-centered software.",
  roles: ["ML Researcher", "AI Engineer", "Builder"],
  location: "Chattogram, Bangladesh",
  email: "sidratulcuet119@gmail.com",
  openTo: "AI research · ML engineering · impactful software",
  // hero image (right side). Put your picture at this path — if the
  // file is missing the site simply hides the frame.
  avatar: "assets/avatar.png",
  // downloadable CV shown on the Resume page
  cv: "assets/CV_Sidratul_Muntaha.pdf",
  links: {
    github: "https://github.com/sidratul-m00ntaha",
  ...
  about: [
    ...
    "I'm particularly drawn to applied ML and AI for social impact — technology that is kind by design. When I'm not training models, I'm probably designing something in Illustrator or befriending a cat. 🐈",
  ],
  traits: [
    "Creative",
    "Visionary",
  ...
  // Ticker strip shown under the hero — add/remove words freely
  ticker: [
    "Computer Vision",
    "NLP",
    "Multimodal AI",
